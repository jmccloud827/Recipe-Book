...
extension Recipe {
    @MainActor static let mozzarellaHerbChickenAndCouscous: Recipe = {
        ...
        methodSection.ingredients = [
            ...
            .init(belongsTo: methodSection, amount: "24", measurement: .ounce, name: "chicken (tenderloins)"),
            ...
            .init(belongsTo: methodSection, amount: "1", measurement: .cup, name: "chicken stock"),
