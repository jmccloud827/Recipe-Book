...
extension Recipe {
    @MainActor static let chorizoRiceSkillet: Recipe = {
        ...
        methodSection.ingredients = [
            ...
            .init(belongsTo: methodSection, amount: "1", measurement: .packet, name: "cojita cheese")
        ]
        methodSection.steps = [
            ...
            .init(belongsTo: methodSection, text: "Top with cojita and eat with some chips if your heart so desires")
        ]
